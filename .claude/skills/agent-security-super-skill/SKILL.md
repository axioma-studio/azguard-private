...
>
> **Related:** for design-time secure-by-design / threat-modeling during architecture work, see
> `architect/security-design` (this skill is run-time/agent-ops; that one is design-side).
