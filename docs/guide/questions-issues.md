...
- AzGuard version (`composer show axioma-studio/azguard`)
- PHP and Laravel versions
- A minimal reproduction or failing test case
- The full stack trace if an exception is thrown
...
Do **not** open a public GitHub issue for security vulnerabilities. Instead, email **security@axioma.studio** with a description and reproduction steps. We will acknowledge your report within 48 hours.
